...
var login = function login ( accountName, password, callback ) {
  ...
  async.waterfall([
    ...
    var configJson = require( app.configFilePath );
    configJson.crosstalkToken = dataBag.crosstalkToken;
    fs.writeFile( app.configFilePath, JSON.stringify( configJson ), 'utf8',
       function ( param ) {
