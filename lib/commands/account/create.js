...
var getMatchingPasswords = function getMatchingPasswords ( dataBag, callback ) {
  ...
  app.log.warn( "*** SECURITY NOTICE ***" );
  app.log.warn( "While Crosstalk is in the current alpha development stage," );
  app.log.warn( "it's messages are being heavily logged for debugging purposes." );
  app.log.warn( "For now, please DO NOT provide a password that you cannot" );
  app.log.warn( "make known to Crosstalk." );
  app.log.warn( "In the future, this will no longer be the case." );
